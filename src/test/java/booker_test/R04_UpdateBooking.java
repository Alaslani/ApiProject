...
/*
    ...
    void updateBookingTest() {
        ...
        BookingPojo expectedData = ObjectMapperUtils.convertJsonToJava(strJson, BookingPojo.class, Employee.class);
        ...
        //Do assertion
        BookingPojo actualData = convertJsonToJava(response.asString(), BookingPojo.class, Employee.class);
