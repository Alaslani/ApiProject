...
public class C28_PojoListGroovy extends JsonPlaceHolderBaseUrl {
    ...
    void pojoListTest() throws JsonProcessingException {
        ...
        JsonPlaceHolderPojo expectedData = convertJsonToJava(strJson, JsonPlaceHolderPojo.class, Employee.class);
        ...
        JsonPlaceHolderPojo actualData = ObjectMapperUtils.convertJsonToJava(actualDataString, JsonPlaceHolderPojo.class, Employee.class);
