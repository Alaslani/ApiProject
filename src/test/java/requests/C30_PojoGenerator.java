...
//To use ObjectMapper with Pojo is the best practice!!!
    void pojoGeneratorTest() {
        ...
        GoRestPojo expectedData = ObjectMapperUtils.convertJsonToJava(strJson, GoRestPojo.class, Employee.class);
        ...
        //Do assertion
        GoRestPojo actualData = ObjectMapperUtils.convertJsonToJava(response.asString(), GoRestPojo.class, Employee.class);
