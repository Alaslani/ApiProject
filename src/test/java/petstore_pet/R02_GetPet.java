...
*/
    ...
    void postTest(){
        ...
        PetPojo expectedData = convertJsonToJava(strJson, PetPojo.class, Employee.class);
        ...
        //Do assertion
        PetPojo actualData = convertJsonToJava(response.asString(), PetPojo.class, Employee.class);
